...
class DPOTrainConfig:
    ...
    sft_adapter_path: str = "./multimodal/checkpoint/qwen2-vl-lora-vqa/checkpoint-600"
    preference_data: str  = "data/preference_data.json"
    output_dir: str       = "multimodal/checkpoint/qwen2-vl-dpo"
    val_split: float      = 0.1
