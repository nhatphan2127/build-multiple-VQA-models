...
### Các đặc điểm chính:
- **Dữ liệu:** >10000 bộ câu hỏi (ảnh, câu hỏi, câu trả lời) với miền dữ liệu chuyên biệt.
...
## 🔍 Phân tích & Đánh giá
- **Kiến trúc rời (A1, A2):** Gặp khó khăn trong việc hội tụ với dữ liệu ít (2000 mẫu), dẫn đến VQA Accuracy thấp. Transformer Decoder có xu hướng nhỉnh hơn LSTM một chút về khả năng nắm bắt ngữ cảnh.
